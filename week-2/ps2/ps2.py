...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        height: an integer > 0
        """
        # self.tileX = [False*i for i in range(width)]
        # self.tileY = [False*i for i in range(width)]
        self.tile = list()
        for x in range(width):
            for y in range(height):
                element = [x, y, False]
                self.tile.append(element)
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        for e in self.tile:
            if m == e[0] and n == e[1] and e[2] == True:
                return True
        return False
        # raise NotImplementedError
    ...
    def updatePositionAndClean(self):
        ...
        while True:
            if self.room.isPositionInRoom(newposition):
                break
            newdirection = random.choice(range(360))
            newposition = self.position.getNewPosition(newdirection, self.speed)
...
def showPlot1(title, x_label, y_label):
    ...
    pylab.show()
# showPlot1("StandartRobot vs RandomWalkRobot", "number of robots", "average steps to clean the room")
...
def showPlot2(title, x_label, y_label):
    ...
    for width in [10, 20, 25, 50]:
        ...
        times1.append(runSimulation(2, 1.0, width, height, 0.8, 100, StandardRobot))
    ...
    pylab.show()
# pylab.figure()
showPlot2("Standart vs Random with Varying Aspect Ratio", "Aspect Ratio", "Avg steps to clean 80%")
